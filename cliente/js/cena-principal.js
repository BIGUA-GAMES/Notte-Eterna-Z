export default class principal extends Phaser.Scene {
  ...
  create() {
    ...
    var currentPosition = this.limbos[0].x;
    var currentYPosition = this.limbos[0].y;
    ...
    var currentPosition = this.limbos2[0].x;
    var currentYPosition = this.limbos2[0].y;
    ...
    var currentPosition = this.limbos3[0].x;
    var currentYPosition = this.limbos3[0].y;
    ...
    var currentPosition = this.limbos4[0].x;
    var currentYPosition = this.limbos4[0].y;
    ...
    var currentPosition = this.limbos5[0].x;
    var currentYPosition = this.limbos5[0].y;
    ...
    var currentPosition = this.limbos6[0].x;
    var currentYPosition = this.limbos6[0].y;
